...
using SharpMusicPlayerDemo.PlayerCore.SampleProviders;
using SharpMusicPlayerDemo.PlayerCore.SoundTouch;
using SharpMusicPlayerDemo.PlayerCore.WaveProviders;
using System;
using System.IO;
...
namespace SharpMusicPlayerDemo.PlayerCore
{
    public class MusicPlayer : IPlayer, IDisposable
    {
        ...
        private static bool UseSoundTouch => true;
        private static bool WaitingMode => false;
